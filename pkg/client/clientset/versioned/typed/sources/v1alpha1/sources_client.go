...
// SourcesV1alpha1Client is used to interact with features provided by the sources.n3wscott.com group.
type SourcesV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SourcesV1alpha1Client) RssFeeds(namespace string) RssFeedInterface {
	return newRssFeeds(c, namespace)
}
